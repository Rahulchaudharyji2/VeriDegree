            ...
            <section className="relative flex items-center justify-center p-8 lg:p-24 overflow-hidden border-r border-white/5">
                ...
                <div className="relative w-full max-w-md animate-in fade-in slide-in-from-left duration-700">
                    <div className="flex items-center gap-3 mb-12">
                        ...
                        <h2 className="text-2xl font-bold text-white tracking-tight text-nowrap">Institution Portal</h2>
                    </div>

                    <div className="mb-10">
                        <h1 className="text-4xl font-bold text-white mb-4">Welcome back, Admin.</h1>
                        <p className="text-gray-400">Securely issue and manage soulbound academic credentials for your students.</p>
                    </div>

                    <form onSubmit={handleUniversityLogin} className="space-y-5">
                    ...
                    <p className="text-center text-gray-500 text-xs mt-12 font-mono uppercase tracking-widest">
                        Standard University Protocol 0x4A
                    </p>
                </div>
            </section>
