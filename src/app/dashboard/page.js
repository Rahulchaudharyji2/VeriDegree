                ...
                <AnimatePresence mode="wait">
                    ...
                    {!accountAddress ? (
                        ...
                        >
                            ...
                            {/* Claim New Degree Section */}
                            <div className="pt-12 border-t border-white/5">
                                <motion.div 
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
                                    viewport={{ once: true }}
                                    className="glass p-10 rounded-[3rem] border-white/5 shadow-2xl relative overflow-hidden group"
                                >
                                    ...
                                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                        ...
                                        <form onSubmit={handleClaim} className="flex flex-col sm:flex-row gap-3">
                                            ...
                                            <button 
                                                ...
                                                className="bg-white hover:bg-gold text-black font-black px-10 py-5 rounded-2xl transition-all shadow-xl active:scale-95 disabled:opacity-50 uppercase tracking-widest text-xs flex items-center justify-center gap-2"
                                            >
